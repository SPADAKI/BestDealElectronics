 ...
 * @author Raymond
 */
@WebServlet(urlPatterns = {"/RentCart"})
public class RentCart extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String rentOrBuy = request.getParameter("rentOrBuy");
        String access = request.getParameter("access");

        /* StoreProduct Function stores the Purchased product in Orders HashMap.*/
        utility.storeProduct(name, type, maker, access, rentOrBuy);
    ...
    protected void displayCart(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (utility.CartCount() > 0) {
            ...
            pw.print("<tr><th></th><th>Rent Options</th><th><select name=\"rent_equipment\">\n"
                    + "    <option value=\"limited_duration_rental\">Limited duration rental</option>\n"
                    + "    <option value=\"single_season_rental\">Single season rental</option>\n"
                    + "  </select></th>");
