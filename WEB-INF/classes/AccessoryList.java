...
public class AccessoryList extends HttpServlet {
    ...
    /* Accessory Page Displays all the Accessories and their Information in Best Deals */
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (CategoryName.equals("oneplus")) {
            ...
            for (Map.Entry<String, SmartPhone> entry : SaxParserDataStore.smartphones.entrySet()) {
                if (entry.getValue().getRetailer().equals("Appe")) {
                    hm.put(entry.getValue().getId(), entry.getValue());
                }
            }
        }

        SmartPhone phone = hm.get(PhoneName);
        ...
        for (Map.Entry<String, String> acc : phone.getAccessories().entrySet()) {
            ...
            pw.print("<li><form method='post' action='Cart'>"
                    ...
                    + "<input type='hidden' name='access' value='" + PhoneName + "'>"
