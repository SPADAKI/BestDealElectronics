...
////////////////////////////////////////////////////////////
     ...
     */
////////////////////////////////////////////////////////////
    // when xml start element is parsed store the id into respective hashmap for laptops, smartphones,tvs etc 
    @Override
    ...
    // when xml end element is parsed store the data into respective hashmap for laptops, smartphones,tvs etc respectively

    @Override
    public void endElement(String str1, String str2, String element) throws SAXException {

        if (element.equals("phone")) {
            smartphones.put(phone.getId(), phone);
            return;
        }
